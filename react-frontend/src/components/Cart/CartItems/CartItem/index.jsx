        ...
        <div className="wrapper card p-3 mb-3">
            <div className="row g-3 align-items-stretch">
                ...
                <div className="col-9 d-flex flex-column justify-content-between">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <p className="card-text mb-0 fw-semibold">${price}</p>
                        <div className="input-group quantity-group" style={{ width: "120px" }}>
                            <button onClick={onRemoveHandler} className="btn btn-outline-secondary" type="button">-</button>
                            <input
                                type="text"
                                className="form-control text-center add-sub-input"
                                value={quantity}
                                readOnly
                            />
                            <button onClick={onAddHandler} className="btn btn-outline-secondary" type="button">+</button>
                        </div>
                    </div>
                </div>
            </div>
